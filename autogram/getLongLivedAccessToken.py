from defines import getInstagramCreds, makeApiCall
...
def getLongLivedAccessToken(params):
    ...
    return makeApiCall(url, endpointParams, type="GET", debug=params['debug'])  # make the api call


params = getInstagramCreds()  # get creds
