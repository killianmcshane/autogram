...
|`4.`|Register a Facebook developer app, then give it [these]() permissions through the API Explorer Tool [here](https://developers.facebook.com/tools/explorer/). |[Here](https://developers.facebook.com/docs/development/create-an-app)|
